...
var questions = {
  ...
  12: "What did the --D-- in --D-Day-- stand for?",
  13: "The Brownie Box Camera introduced by Eastman Kodak in 1900 had a retail price of what?",
...
var choices = {
  ...
  3: ["A. Buttermilk", "B. Daisy", "C. Scout", "D. Tulip"],
  4: [
  ...
  10: ["A. 10 percent", "B. 15 percent", "C. 31 percent", "D. 51 percent"],
  11: [
  ...
  12: ["A. doom", "B. day", "C. Dwight (Eisenhower)", "D. Dunkirk"],
  13: ["A. $1", "B. $5", "C.$10", "D.$20"],
  14: [
    "A. Charlie Brown",
    "B. Bugs Bunny",
    "C. Mickey Mouse",
  ...
  15: ["A. 1960", "B. 1980", "C. 1970", "D. never"],
  16: [
  ...
  17: ["A. 1", "B. 57", "C. 571", "D. 200"],
  18: ["A. James", "B. John", "C. Joseph", "D. Jane"],
  19: [
  ...
  20: ["A. 1968", "B. 1978", "C. 1988", "D. 1995"]
};
...
function addQuestion() {
  for (var i = 1; i < 5; i++) {
    $("#question" + i).append(questions[i]);

    var radioButton = $('<input type="radio" name="radio" />');
    $(radioButton).setAttribute("value", [i][0]);

    $("#choiceA").append(choices[i][0]);
    $("#choiceB").append(choices[i][1]);
    $("#choiceC").append(choices[i][2]);
    $("#choiceD").append(choices[i][3]);
  }
}

// function addQuestion() {
//   for (var i = 1, j = 0; i < 5, j < 5; i++, j++) {
//     $("#question" + i).append(questions[i]);
//     $("#choice_" + j).text(choices[j]);
//     console.log($("#choice_" + j));
//     console.log(choices[i][j]);

//     // var choiceA = $("#choices" + i).text(choices[i][j]);
//     // var radioButton = $('<input type="radio" name="radio" />');

//     // radioButton.prependTo($("#choices" + i));
//     // choiceA.append($("#choices" + i));
//   }
// }
// function addChoices() {
//     for (var i = 1; i < 5; i++) {
//       var radioButton = $('<input type="radio" name="radio" />');
//       radioButton.appendTo(".q_container");
//     }
//   }
addQuestion();
// addChoices()
